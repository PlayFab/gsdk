...
public:
	...
	UFUNCTION(BlueprintPure, Category="PlayFabGSDK|Server Info")
	...
	UFUNCTION(BlueprintCallable, Category="PlayFabGSDK|Players")
	...
	UFUNCTION(BlueprintPure, Category="PlayFabGSDK|Players")
	...
	UFUNCTION(BlueprintCallable, Category="PlayFabGSDK|Callbacks")
