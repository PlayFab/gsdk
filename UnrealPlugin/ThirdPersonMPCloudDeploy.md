...
* MPS is [enabled for your title](https://docs.microsoft.com/en-us/gaming/playfab/features/multiplayer/servers/enable-playfab-multiplayer-servers), and billing is set up
...
* In the top left of the Unreal editor menu, click on File -> Package -> Target Configuration -> {ProjectName}Server
* In the top left of the Unreal editor menu, click on File -> Package -> SOMETHING SOMETHING -> Shipping
* File -> Package -> Windowsx64
...
* Once verified with LocalMultiplayerAgent, consult the [creating a build guide](https://docs.microsoft.com/en-us/gaming/playfab/features/multiplayer/servers/deploying-playfab-multiplayer-server-builds)
	...
	* The proper way to do this on a client is a separate topic covered in our  [allocation guide.](https://docs.microsoft.com/en-us/gaming/playfab/features/multiplayer/servers/allocating-game-servers-and-configuring-vs-debugging-tools)
...
* Get familiar with the [build creation process guide](https://docs.microsoft.com/en-us/gaming/playfab/features/multiplayer/servers/deploying-playfab-multiplayer-server-builds)
...
* In "Server Details", choose "Process" and "Windows"
...
* Click "Add Build"
* Skip ahead to configure the regions
...
#### Configure regions for created build
...
* Click the new build
* This should put you into the Regions view for this build
* Add Region
	* In the prerequisites, you will have reserved some availability in some predefined regions.
	* Pick an available region close to you
	* Target Standby: 1
	* Maximum: 1
* Submit
